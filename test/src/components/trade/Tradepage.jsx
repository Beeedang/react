       ...
       <div className='trade-result-header'>거래 기록</div>
        <div className='trade-result'>
          {tradeRecords.map(record => {
            ...
            return (
              <div key={record.saleSn} className='trade-box'>
                ...
                <div className='trade-name2'>
                 <div className='trade-price'>거래가: <br />{record.value.toLocaleString()}</div>
                 <div className='trade-marketprice'>현재시세: <br />{price.toLocaleString()}</div>
                 <div className='trade-diffprice'>차액: <br />{diffpriceWithSign} ({diffRatio > 0 ? "+" : "-"}{Math.abs(diffRatio)}%)</div>
                </div>
              </div>
            );
          })}
